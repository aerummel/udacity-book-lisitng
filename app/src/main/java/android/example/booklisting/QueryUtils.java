...
public final class QueryUtils {
    ...
    private static List<Book> extractItemFromJson(String bookJSON) {
        ...
        try {
            ...
            for (int i = 0; i < bookArray.length(); i++) {
                ...
                // Create String to hold all author names
                String authorString = "";

                // Loop through the authors array and create a string of all author names
                ...
                // Create a new {@link Book} object with the title and author names
     ...
     */
    public static List<Book> fetchBookData(String requestUrl, String search) {

        Log.v(LOG_TAG, "Book data is being fetched for: " + search);
